...
<div id="container">
    ...
    <nav>
    	<ul>
        	...
        	<li class="start selected"><a href="companyhome.jsp">Home</a></li>
           

	       <li><a href="companyview.jsp"><span></span> ClassWise</a></li>
	        <li><a href="companybacklog.jsp"><span></span> Student backlogs</a></li>
...
<form action="companymarksvie.jsp">
    <table align="center"><tr><td>
<b align='center'>BRANCH :</td><td><select name='branch'>
