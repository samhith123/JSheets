	...
	<div id="container">
		...
		<nav>
			<ul>
				...
				<li class="start selected"><a href="addsubject.jsp"><span></span>ADD SUBJECT</a></li>
		...
		<div id="body">
			...
			<section id="content">
				...
				<div class="article-info">
					...
					<form action="addSubjectProcess.jsp">
						<br>
						<br>
						<center>
							<table align="">
								...
								<tr>
									<td><b align='center'>SUB CODE:</b></td>
									<td><input type="text" name="scode" /></td>
								</tr>
								<tr>
									<td><b align='center'>SUB NAME:</b></td>
