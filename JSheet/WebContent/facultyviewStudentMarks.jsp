	...
	<div id="container">
		...
		<nav>
			<ul>
				...
				<li class="start selected"><a href="facultyclasswise.jsp"><span></span>ClassWise</a></li>


				<li><a href="subjectwise.jsp"><span></span>subject wise
						Result</a></li>
			...
			<section id="content">
				...
				<div class="article-info">
					...
					<%
						...
						pst = con
								.prepareStatement("select subcode from subject where branchid=? and semid=?");
						try {
					...
					<form action="viewStudentMarks.jsp">
						...
						<table align="center" border="1">
							<tr>
								<td><b align='center'>HallTicketNo </b></td>
								<td><b align='center'>Sub1</b></td>
								<td><b align='center'>Sub2</b></td>
								<td><b align='center'>Sub3</b></td>
								<td><b align='center'>Sub4</b></td>
								<td><b align='center'>Sub5</b></td>
								<td><b align='center'>Sub6</b></td>
								<td><b align='center'>Sub7</b></td>
								<td><b align='center'>Sub8</b></td>
								<td><b align='center'>total</b></td>
								<td><b align='center'>Avg</b></td>
							</tr>
