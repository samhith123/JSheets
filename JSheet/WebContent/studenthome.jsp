...
<body>
	<div id="container">
		...
		<ul>
			...
			<li class="start selected"><a href="studenthome.jsp">Home</a></li>
...
<br>
				...
				%>
				<h3 align="center">WELCOME TO STUDENT REPORT GENERATOR:</h3>
				<h3 align="center"><%=session.getAttribute("uname")%></h3>
			</div>
			</section>
